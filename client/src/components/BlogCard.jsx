            ...
            <div className="min-h-screen flex w-full  items-center flex-col">
                ...
                <form action="" className="flex flex-col w-10/12 gap-5">
                    ...
                    <div className="w-full flex justify-center">
                        {
                            previewUrl ? <img src={previewUrl} className=' rounded-md w-full bg-cover h-96 object-cover bg-center' /> : ''
                        }
                    </div>
...
// Assuming blog.blogImgFile is "/uploads/blogs/filename.jpg"
// const backendUrl = "http://localhost:8000"; // Change if your backend runs on a different port

<img
  src={blog.blogImgFile?.startsWith('/uploads') ? `${BACKEND_URL}${blog.blogImgFile}` : blog.blogImgFile}
  alt={blog.blogTitle}
